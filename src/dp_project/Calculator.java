...
public final class Calculator extends javax.swing.JFrame {
    ...
    private void undo() {
        CalculatorFacade.CalculatorState state = facade.undo();
        if (state == null) return;

        this.currentOperand   = state.currentOperand;
        this.expressionList   = new ArrayList<>(state.expressionList);
        this.operationsList   = new ArrayList<>(state.operationsList);
        this.expressionText   = state.expressionText;
